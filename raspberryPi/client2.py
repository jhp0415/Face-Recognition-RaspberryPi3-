...
if __name__ == '__main__':
    ...
    serverIp = "ec2-13-124-248-96.ap-northeast-2.compute.amazonaws.com"  # 전송할 서버 IP주소
    serverPort = 9000  # AWS TCP Port 주소
    filepath = Frame.PATH + "\\" + Frame.dir_name + "\\" + "2018-8-10_21-44-24_0.jpg"  # 전송하고자 할 파일이 있는 디렉토리 경로
